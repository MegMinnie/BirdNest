...
const Inicial = () => {
    const cards = [
        {
            ...
            assunto:
                "Lorem Ipsum is simply dummy text of the printing and typesetting industry. It has survived not only five centuries, but also the leap into electronic typesetting, remaining unchanged. At vero eos et accusamus.",
            idadeBotao: "16+",
    ...
    return (
        <>
            <div
                className="cabecalho"
                style={{ backgroundImage: `url(${corvo})` }}
            >
                <Header className="header" logo={logo} />
                <section className="apresentacao">
                    <h1 className="tituloPrincipal">BirdNest</h1>
                    <p>
                        O BirdNest é um espaço para escrever seu livro, seja no
                        formato de Histórias Originais ou de Fanfics, além de
                        permitir acessar outras narrativas.
                    </p>
                    <button className="botao-cadastrar">
                        CADASTRE-SE JÁ GRÁTIS!
                    </button>
                </section>
            </div>
            <main className="principal">
                ...
                <section
                    className="capa"
                    style={{ backgroundImage: `url(${tela})` }}
                >
                    <h1>Dê asas a sua imaginação</h1>
                    <p>
                        Encontre histórias de diversos gêneros, troque ideias,
                        faça amigos, personalize seu perfil e compartilhe com o
                        mundo sua criatividade!
                    </p>
                </section>
